		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "fiorichallenge",
									"targetURL": "#T180fiorichallenge-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"T180fiorichallenge-display": {
								"semanticObject": "T180fiorichallenge",
								"action": "display",
								"description": "Think180 SAPUI5 challenge Task",
								"title": "fiorichallenge",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=T180.fiorichallenge",
									"url": sap.ui.require.toUrl("T180/fiorichallenge")
								}
							}
						}
					}
